...
const Hero = () => {
  return (
    <div className='heroic flex justify-center items-center'>
      <div className='Words flex-col flex max-w-[50rem] text-center justify-center items-center'>
        ...
        <button className="border w-40 rounded-full h-11 bg-Comp text-black my-4 flex items-center justify-center space-x-2"><span>Explore more</span> <MdArrowCircleRight /></button>
      </div>
    </div>
  )
}
