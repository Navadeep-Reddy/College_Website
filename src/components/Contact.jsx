    ...
    <div className='w-[70%] mx-auto mt-10 flex' name = "Cont">
      ...
      <div className='Form w-1/2 p-5'>
        ...
        <form className='flex flex-col' onSubmit={onSubmit}>
            ...
            <button className='flex space-x-2 border bg-Accent w-40 h-11 my-5 text-white items-center justify-center rounded-3xl border-none'><span>Submit Now</span><MdLocalPostOffice /></button>
        </form>
