...
const Gallery = () => {
  return (
    ...
    <button className="border border-none w-40 rounded-full h-11 bg-Accent text-Comp flex items-center justify-center space-x-2"><span>See more here</span><FaLongArrowAltRight /></button>
